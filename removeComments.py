    ...
    def removeComments(self, source: List[str]) -> List[str]:
        ...
        while len(source) > 0:
            ...
            if blockFlag:
                ...
                for i in range(1,len(line)-1):
                    if line[i:i+2] == r'/*':
                        ...
                        if inlineblockComment:
                            code_stack.append(code_stack.pop() + line[0:i])
                            inlineblockComment = False
                        else:
                            code_stack.append(line[0:i])
                ...
                if not commentFlag:
                    if inlineblockComment:
                        code_stack.append(code_stack.pop() + line)
                        inlineblockComment = False
                    else:
...
if __name__ == '__main__':
    ...
    ["aec*", "ec", "ddadbede", "e", "eed*", "bab", "c/bb*", "cbae*", "dcabebdc", "badcc", "dd*", "eb/dcdbaaadd", "ba*",
     "ab", "*", "*", "aeabdccccd", "c/aa", "de/aedb*", "*", "*", "/dc", "e/edceacc/ea*", "ca", "ec", "ebdce", "dadc",
     "eadddaabebeedd", "cbeadebcaebded*", "ee", "eb", "dd", "cbccc", "da*", "d*", "b*", "dac*", "de", "e", "b", "dbbbe",
     "ccd*", "*", "adaabdaaea", "eec*", "/a/addc", "*", "*", "/ddddcab*", "cb*", "b*", "*", "aaadddd", "bd*", "ad", "*",
     "*", "e", "a*", "a", "d*", "e*", "cedc*", "*", "*", "eb", "*", "b*", "*", "ba*", "da*", "eccd*/ab", "*",
     "*/cbcedae*", "a", "aa", "*", "cadbbd", "d", "*", "c", "d/d", "d/c", "dbbdedece"]

    ["aec*", "ec", "ddadbede", "eeed*", "babc/bb*", "cbae*", "dcabebdc", "badcc", "dd*", "eb/dcdbaaadd", "ba*", "ab",
     "*", "*", "aeabdccccd", "c/aa", "de/aedb*", "*", "*", "/dc", "e/edceacc/ea*", "ca", "ec", "ebdce", "dadc",
     "eadddaabebeedd", "cbeadebcaebded*", "ee", "ebdd", "cbccc", "da*", "d*", "b*", "dac*", "de", "e", "bdbbbe", "ccd*",
     "*", "adaabdaaea", "eec*", "/a/addc", "*", "*", "/ddddcab*", "cb*", "b*", "*", "aaaddddbd*", "ad", "*", "*", "ea*",
     "ad*", "e*", "cedc*", "*", "*", "eb", "*", "b*", "*", "ba*", "da*", "eccd*/ab", "*", "*/cbcedae*", "a", "aa", "*",
     "cadbbdd", "*", "c", "d/dd/c", "dbbdedece"]
